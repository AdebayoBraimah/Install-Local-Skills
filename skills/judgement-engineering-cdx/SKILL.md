---
name: judgement-engineering-cdx
description: Governs problem framing, decision quality, and reversible next steps before engineering planning. Use when goals are fuzzy, unclear, contradictory, high-impact, under-specified, hidden-assumption driven, likely to drift, or when Codex must decide what should be built before writing an implementation plan.
---
