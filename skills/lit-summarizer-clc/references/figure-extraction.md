...
- **Inkscape skill**: `/inkscape` — invoke for full command reference and workflows
...
2. **Read each image** via the Read tool (multimodal) and discard:
...
# Step 2: Read the full-page image with Read tool, identify bounding box (x, y, width, height in pixels)
