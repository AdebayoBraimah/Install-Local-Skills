...
If you need deeper detail on a specific paper, use `rg` to inspect its frontmatter (Keywords, Take Home Message from `ad-abstract` admonition) -- do NOT read full literature notes unless essential.
