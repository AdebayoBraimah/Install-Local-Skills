...
- **Check existing hubs first**: Use `rg 'ad-tldr' Ideas Ideas/Research`
...
1. Extract Keywords + Take Home Message from each batch note with `rg` and targeted reads (not full-note reads)
