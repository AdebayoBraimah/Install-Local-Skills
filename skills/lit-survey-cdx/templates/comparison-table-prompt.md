...
Strategy: Use `rg 'tag: hub-note|- hub-note' Ideas/Research Ideas` to find hub notes, then for each hub, read only the Key Papers section (stop at the next `##` heading).
